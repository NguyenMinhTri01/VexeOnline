<template>
    <div class="container-fluid">
        <h1 class="h4 mb-2 text-gray-800">Cập Nhập Chuyến Đi</h1>
...
import ClassicEditor from '@ckeditor/ckeditor5-build-classic';
    export default {
        ...
        computed : {
          ...
          routes(){
              return this.$store.state.trip.route
          },
          vehicles(){
              return this.$store.state.trip.vehicle
          },
          garages(){
              return this.$store.state.trip.garage
          }
        },
        methods: {
            handleSubmit(event) {
