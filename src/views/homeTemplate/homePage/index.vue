        ...
        <div class="col-md-7 bann-info wow fadeInRight animated" data-wow-delay=".5s">
          ...
          <div class="ban-bottom">
            <div class="bnr-right">
              ...
              <Datepicker v-model="date1" :format="customFormatter(date1)" />
            </div>
            <div class="bnr-right">
              ...
              <Datepicker v-model="date2" :format="customFormatter(date2)" />
...
<div class="col-md-6 track-right wow fadeInLeft animated" data-wow-delay=".5s">
			<a href="track.html"><img src="../../../assets/frontend/images/map1.png" class="img-responsive" alt=""></a>
		</div>
